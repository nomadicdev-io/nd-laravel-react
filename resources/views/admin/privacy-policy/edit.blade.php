			...
			<div class="card mg-b-20">
				...
				<div class="row mg-b-20">
					<div class="col-sm-6 form-group">
						...
						<textarea id="description" name="meta[text][description]" class="form-control ckeditorEn" required> {!! $postDetails->getMeta('description') !!} </textarea>
				   	</div>
				   	<div class="col-sm-6 form-group multi-lang">
						<label for="description_arabic" class="col-form-label">Description [Arabic] <em>*</em></label>
						<textarea id="description_arabic" name="meta[text][description_arabic]" class="form-control ckeditorAr" required> {!! $postDetails->getMeta('description_arabic') !!} </textarea>
				   	</div>
				</div>
