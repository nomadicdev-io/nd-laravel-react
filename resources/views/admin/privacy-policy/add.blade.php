		...
		<input type="hidden" name="post[type]" value="{{$postType}}" />
			...
			<div class="card mg-b-20">
				<div class="card-body">
					...
					<div class="row mg-b-20">
						<div class="col-sm-6 form-group">
							<label for="description" class="col-form-label">Description <em>*</em></label>
							<textarea id="description" name="meta[text][description]" class="form-control ckeditorEn" required> {!! old('meta')['text']['description'] ?? "" !!} </textarea>
					   	</div>
					   	<div class="col-sm-6 form-group multi-lang">
							<label for="description_arabic" class="col-form-label">Description [Arabic] <em>*</em></label>
							<textarea id="description_arabic" name="meta[text][description_arabic]" class="form-control ckeditorAr" required> {!! old('meta')['text']['description_arabic'] ?? "" !!} </textarea>
					   	</div>
					</div>
