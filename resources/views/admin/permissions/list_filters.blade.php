    ...
    <div class="card">
      ...
      <div id="collapseOne" data-parent="#accordion" class="collapse" role="tabpanel" aria-labelledby="headingOne">
        <div class="card-body searchSection">
              ...
              {{ Form::open(array('name'=>'filter-reg','url'=>route('permission_list'),'method'=>'get' )) }}
                 <div class="row">
                  <div class="col-sm-6">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <a href="{{ route('permission_list') }}"><input type="button" name="filterNow" class=" btn btn-primary" value="{{ lang('reset') }}" /></a>
                    </div>
                  </div>
                </div>
