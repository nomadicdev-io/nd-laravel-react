            ...
            <section class="basic_settings">
                <div class="row mg-b-20 ">
                    ...
                    <div class="col-sm-6 form-group">
                        ...
                        <textarea id="description_arabic" name="meta[text][description_arabic]" class="form-control ckeditorAr"> {!! old('meta')['text']['description_arabic'] ?? '' !!} </textarea>
                    </div>
                    ...
                    @php
                        $uploaderArr = [
                            [
                                ...
                                'type' => 'image',
                                'old_file_name' => old('meta')['text']['about_banner'] ?? '',
                                'required' => true,
                                'mimes' => ['jpg', 'jpeg', 'png'],
                                'postType'=>$postType
                            ],
