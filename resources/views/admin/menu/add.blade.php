	...
	<div class="row row-xs mg-b-20">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
				...
				<input type="hidden" name="post[type]" value="menu" />
				<div class="card-body">
					 <div class="col-sm-12">
							...
							<section class="">
								...
								<div class="row"> 	
									<div class="col-sm-6 form-group">
										...
										<input type="text" name="post[title]" class="form-control" placeholder="" value="{{ old('post')['title'] ?? ""}}"  required /> 
									</div>	
									
									<div class="col-sm-6 form-group">
										<label>Menu Name [Arabic]<em class="red">*</em></label>
										<input type="text" name="post[title_arabic]" class="form-control" placeholder="" value="{{old('post')['title_arabic'] ?? "" }}"  dir="rtl" required /> 
									</div>
								</div>
								<div class="row"> 	
									<div class="col-sm-6 form-group">
										<label>Menu Large Name</label>
										<input type="text" name="meta[text][large_title]" class="form-control" placeholder="" value="{{old('meta')['text']['large_title'] ?? "" }}"  /> 
									</div>	
									
									<div class="col-sm-6 form-group">
										<label>Menu Large Name [Arabic]</label>
										<input type="text" name="meta[text][large_title_arabic]" class="form-control" placeholder="" value="{{old('meta')['text']['large_title_arabic'] ?? "" }}"  dir="rtl"/> 
									</div>
								</div>
								...
								<div class="row"> 	
									<div class="col-sm-6 form-group">
										...
										<input type="text" name="meta[text][icon_class]" class="form-control" placeholder="" value="{{ old('meta')['text']['icon_class'] ?? "" }}"  /> 
									</div>	
									<?php /*
									<div class="col-sm-6 form-group">
										<label>Menu Icon [svg,png]</label>
										<input type="file" name="post_icon_file" class="form-control" placeholder="" value=""  /> 
									</div>	*/ ?>
								</div>
							...
							<section class="basic_settings">					
								<div class="row"> 
									 <div class="col-sm-6 form-group">
										...
										<input type="number" name="post[priority]" class="form-control" placeholder="" value="{{ ( old('post')['priority'] ?? "") ? old('post')['priority'] ?? "" : 1 }}"  min="1" /> 
									</div>	
									<div class="col-sm-6 form-group">
										<label>Status<em class="red">*</em></label>
										<select name="post[status]" class="form-control">
										  <option value="1" {!! ( old('post')['status'] ?? "" == '1' ) ? 'selected="selected"' : '' !!}>Activate</option>
										  <option value="2" {!! ( old('post')['status'] ?? "" == '2' ) ? 'selected="selected"' : '' !!}>Deactivate</option>
										 </select>
									</div>
								</div>
							</section>
