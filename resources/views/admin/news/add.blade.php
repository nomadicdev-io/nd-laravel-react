                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="post_lang" name="post[lang]">
                            ...
                            <option {{ ( old('post')['lang'] ?? "" == 'en' )? 'selected' : '' }} value="en">English
                            </option>
                            <option {{ ( old('post')['lang'] ?? "" == 'ar' )? 'selected' : '' }} value="ar">Arabic
                            </option>
                        </select>
                    </div>
                </div>
                <div class="col-sm-6 form-group">
                    <label for="news_date" class="col-form-label">News Date <em>*</em></label>
                    <input type="text" autocomplete="off" name="meta[date][news_date]" id="news_date"
                        class="form-control datepicker" placeholder=""
                        value="{{ old('meta')['date']['news_date']?? "" }}" required />
                </div>
            </div>
            <div class="row">
            ...
            <div class="row mg-b-20 ">
                ...
                $uploaderArr = [
					[
						...
						'type'=> 'image',
						'old_file_name'=> old('meta')['text']['news_image']?? "",
						'required'=>true,
						'mimes'=>['jpg', 'jpeg', 'png'],
					],
                ];
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input type="number" min="1" name="post[priority]" id="post_priority" class="form-control"
                        placeholder="" value="{{ $priority  }}" required />
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
