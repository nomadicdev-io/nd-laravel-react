            ...
            <section class="basic_settings">
                <div class="row mg-b-20 ">
                    ...
                    <div class="col-sm-6 form-group">
                        ...
                        <input autocomplete="off" type="text" id="publish_date" name="meta[date][publish_date]"
                            class="form-control datepicker" value="{!! old('meta')['date']['publish_date'] ?? '' !!}">
                    </div>
                    ...
                    @php
                        $uploaderArr = [
                            [
                                ...
                                'type' => 'image',
                                'old_file_name' => old('meta')['text']['gallery_banner'] ?? '',
                                'required' => false,
                                'mimes' => ['jpg', 'jpeg', 'png'],
                            ],
                        ];
