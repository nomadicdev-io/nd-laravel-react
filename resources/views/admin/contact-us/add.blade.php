				...
				<div class="card-body">
					...
					<div class="row mg-b-20 ">
						<div class="col-sm-6 form-group">
							...
							<input type="text" name="meta[text][location]" id="location" class="form-control" placeholder="" value="{{ old('meta')['text']['location'] ?? "" }}" required/>
						</div>
						<div class="col-sm-6 form-group">
							<label for="location_arabic" class="col-form-label">Location [Arabic]<em>*</em></label>
							<input dir="rtl" type="text" name="meta[text][location_arabic]" id="location_arabic" class="form-control" placeholder="" value="{{ old('meta')['text']['location_arabic'] ?? "" }}" required/>
						</div>
					</div>
					...
					<div class="row mg-b-20 ">
				    	<div class="col-sm-6 form-group">
							...
							<input type="time" name="meta[text][opening_time]" id="opening_time" dir="rtl" class="form-control" placeholder="" value="{{ old('meta')['text']['opening_time'] ?? "" }}" required />
						</div>
						<div class="col-sm-6 form-group">
							<label for="closing_time" class="col-form-label">Closing Time<em>*</em></label>
							<input type="time" name="meta[text][closing_time]" id="closing_time" dir="rtl" class="form-control" placeholder="" value="{{ old('meta')['text']['closing_time'] ?? "" }}" required />
						</div>
					...
					<div class="row mg-b-20">
						<div class="col-sm-6 form-group">
							...
							<input type="text" name="meta[text][open_days]" id="open_days" class="form-control" placeholder="" value="{{ old('meta')['text']['open_days'] ?? "" }}" required />
						</div>
						<div class="col-sm-6 form-group">
							<label for="open_days_arabic" class="col-form-label">Open Days [AR]<em>*</em></label>
							<input type="text" name="meta[text][open_days_arabic]" id="open_days_arabic" class="form-control" placeholder="" value="{{ old('meta')['text']['open_days_arabic'] ?? "" }}" required />
						</div>
					</div>
					...
					<div class="row mg-b-20 ">
						<div class="col-sm-6 form-group">
							...
							<input type="text" name="meta[text][map_url]" id="map_url" class="form-control" placeholder="" value="{{ old('meta')['text']['map_url'] ?? "" }}" required/>
						</div>
					</div>
					...
					<div class="row mg-b-20 ">
						<div class="col-sm-4 form-group">
							...
							<input type="text" name="meta[text][contact_email]" id="contact_email" class="form-control" placeholder="" value="{{ old('meta')['text']['contact_email'] ?? "" }}" required/>
						</div>
						<div class="col-sm-4 form-group">
							<label for="contact_tollfree" class="col-form-label">Toll-free<em>*</em></label>
							<input type="text" name="meta[text][contact_tollfree]" id="contact_tollfree" class="form-control" placeholder="" value="{{ old('meta')['text']['contact_tollfree'] ?? "" }}" required/>
						</div>
						<div class="col-sm-4 form-group">
							<label for="contact_phone" class="col-form-label">Phone Number<em>*</em></label>
							<input type="text" name="meta[text][contact_phone]" id="contact_phone" class="form-control" placeholder="" value="{{ old('meta')['text']['contact_phone'] ?? "" }}" required/>
						</div>
					</div>
						...
						@php
							$uploaderArr = [
								[
									...
									'type'=> 'image',
									'old_file_name'=> old('meta')['text']['inner_page_banner_image'] ?? "",
									'required' => true,
									'mimes'=>['jpg', 'jpeg', 'png'],
								],
				            ];
